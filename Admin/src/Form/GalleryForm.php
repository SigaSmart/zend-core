...
class GalleryForm extends AbstractForm
{
	...
	public function CheckFolder($Folder,$id) {
		...
		$this->CreateFolder("{$this->basePath}{$this->ds}dist{$this->ds}uploads{$this->ds}images{$this->ds}{$Folder}{$this->ds}{$y}{$this->ds}{$m}{$this->ds}{$id}{$this->ds}");
		$this->CreateFolder("{$this->basePath}{$this->ds}dist{$this->ds}uploads{$this->ds}images{$this->ds}{$Folder}{$this->ds}{$y}{$this->ds}{$m}{$this->ds}{$id}{$this->ds}{$this->ds}gallery{$this->ds}");
		$this->basePath = "{$this->basePath}{$this->ds}dist{$this->ds}uploads{$this->ds}images{$this->ds}{$Folder}{$this->ds}{$y}{$this->ds}{$m}{$this->ds}{$id}{$this->ds}gallery{$this->ds}";
		$this->send="dist{$this->ds}uploads{$this->ds}images{$this->ds}{$Folder}{$this->ds}{$y}{$this->ds}{$m}{$this->ds}{$id}{$this->ds}gallery{$this->ds}";
	}
