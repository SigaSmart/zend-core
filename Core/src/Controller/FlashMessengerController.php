...
class FlashmessengerController extends AbstractActionController
{
    ...
    public function jsAction(){
        ...
        $js=  file_get_contents($this->getRequest()->getServer('DOCUMENT_ROOT')."/assets/toastr.min.js");
    ...
    public function cssAction(){
        ...
        $css=  file_get_contents($this->getRequest()->getServer('DOCUMENT_ROOT')."/assets/toastr.min.css");
