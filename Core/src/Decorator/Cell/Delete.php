...
class Delete extends AbstractCellDecorator
{
    ...
    public function render($context)
    {
        ...
        return sprintf('<a class="btn btn-xs btn-danger btn-flat j_confirm"  href="%s"><i class="fa fa-trash-o"></i> </a>', str_replace(" ","",$url));
    }
}
